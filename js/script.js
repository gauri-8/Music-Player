console.log('lets write some javscript')
...
async function displayAlbums() {
  ...
  let a = await fetch(`http://127.0.0.1:3001/songs1/`)
  let response = await a.text();
  ...
  for (let index = 0; index < array.length; index++) {
    ...
    if (e.href.includes("/songs1") ) {
      ...
      cardContainer.innerHTML= cardContainer.innerHTML + ` <div data-folder="${folder}" class="card ">
            ...
            <img src= "/songs1/${folder}/cover.jpg">
...
Array.from(document.getElementsByClassName("card")).forEach(e => {
  e.addEventListener("click", async item => {
    ...
    async function main() {
      ...
      //Attach event listener to play next
      ...
      //Listen for timeupdate. gaane ka time update hoga
      ...
      //Add event listenenr for previous
